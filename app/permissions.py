...
PERMISSIONS = [
    ...
    ("PICK_TICKET_BULK_PRINT", "Bulk print pick tickets", "Orders"),
    ("PICK_TICKET_UPDATE", "Update pick ticket unit substitution", "Orders"),
    ("INVENTORY_ISSUES_VIEW", "View inventory issues", "Inventory"),
    ("INVENTORY_ISSUES_RESOLVE", "Resolve inventory issues", "Inventory"),
    ...
    ("ALLOCATION_RUN", "Run allocation", "Allocation"),
    ("ALLOCATION_BULK_RUN", "Run bulk allocation", "Allocation"),
    ("PARTIAL_ALLOCATION_APPROVE", "Approve partial allocation", "Allocation"),
    ("ALLOCATION_RELEASE", "Release allocation", "Allocation"),
    ("ALLOCATION_REPORT_VIEW", "View daily allocation exceptions", "Allocation"),
    ("ALLOCATION_REPORT_EXPORT", "Export daily allocation exceptions", "Allocation"),
